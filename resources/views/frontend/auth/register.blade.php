    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::open(['url' => 'registerUser', 'method' => 'post', 'files' => true])!!}
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="user_image" type="file" class="form-control @error('user_image') is-invalid @enderror" name="user_image" required autocomplete="new-user_image">
