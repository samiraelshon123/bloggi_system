            ...
            <div class="col-lg-9 col-12">
                ...
                @endif
                            ...
                            <div class="post_header">
                                ...
                                <div class="blog-date-categori">
                                    <ul>
                                        ...
                                        <li><a href="{{url('user/author/'.$post->user->username)}}" title="Posts by {{$post->user->name}}" rel="author">{{$post->user->name}}</a></li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <ul class="comment__list">
                            ...
                            <li>
                                <div class="wn__comment">
                                    <div class="thumb">
                                        {{-- get_gravatar -> get image of user email amd function in 'app/Helper/GeneralHelper.php' --}}
                    ...
                    <div class="comment_respond">
                        ...
                        {!!Form::open(['url' => 'user/store_comment/'.$post->id, 'method' => 'post', 'class' => 'comment__form'])!!}
