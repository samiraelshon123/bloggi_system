...
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex">
      <h6 class="m-0 font-weight-bold text-primary">Edit Comment ({{$comment->post->title}})</h6>
      <div class="ml-auto">
        <a href="{{url('admin/post_comments_index')}}" class="btn btn-primary">
    ...
    {!! Form::model($comment, ['url' => 'admin/post_comments_update/'.$comment->id, 'method' => 'post']) !!}
    <div class="row">
        <div class="col-4">
        ...
        <div class="col-4">
            <div class="form-group">
                {!! Form::label('url', 'Url') !!}
                {!! Form::text('url', old('url', $comment->email), ['class' => 'form-control']) !!}
    ...
    <div class="row">
        <div class="col-12">
            ...
            {!! Form::textarea('comment', old('comment', $comment->email), ['class' => 'form-control', 'rows' =>5]) !!}
