...
<div class="card shadow mb-4">
    ...
    {!! Form::model($post, ['url' => 'admin/posts_update/'.$post->id, 'method' => 'post', 'files' => true]) !!}
    <div class="row">
        <div class="col-12">
    ...
    <div class="row">
        <div class="col-12">
            <div class="form-group">
                ...
                {!! Form::textarea('descreption', old('description', $post->description), ['class' => 'form-control summernote']) !!}
                ...
                initialPreviewConfig: [
                    @if($post->media->count() > 0)
                        @foreach($post->media as $media)
                            ...
                            {caption: "{{ $media->file_name }}", size: {{ $media->file_size }}, width: "120px", url: "{{ url('admin/post_media_destroy', [$media->id, '_token' => csrf_token()]) }}", key: "{{ $media->id }}"},
                        @endforeach
                    @endif
                ],
            });
