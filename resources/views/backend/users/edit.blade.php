...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            ...
            <div class="ml-auto">
                <a href="{{ url('admin/users_index') }}" class="btn btn-primary">
        ...
        <div class="card-body">
            ...
            {!! Form::model($user, ['url' => ['admin/users_update/'.$user->id], 'method' => 'post', 'files' => true]) !!}
            <div class="row">
                <div class="col-3">
    ...
    <script>
        $(function () {
            ...
            $('.removeImage').click(function () {
                $.post('{{ url('admin/user_media_destroy') }}', { user_id: '{{ $user->id }}', _token: '{{ csrf_token() }}' }, function (data) {
                    if (data == 'true') {
