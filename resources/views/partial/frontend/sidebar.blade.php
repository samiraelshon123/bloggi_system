<div class="wn__sidebar">
    ...
    <aside class="widget search_widget">
        ...
        <div class="form-input">
            ...
            {!! Form::button('<i class="fa fa-search"></i></button>', ['type' => 'submit']) !!}
            ...
            <ul>
                ...
                <li>
                    <div class="post-wrapper d-flex">
                        <div class="thumb">
                            <a href="{{url('user/post_show/'.$recent_post->id)}}">
                        ...
                        <div class="content">
                            <h4><<a href="{{url('user/post_show/'.$recent_post->id)}}">{{\Illuminate\Support\Str::limit($recent_post->title, 15, '...')}}</a></h4>
        ...
        <ul>
            ...
            <li>
                <div class="post-wrapper">
                    <div class="thumb">
                        {{-- @if (get_gravatar($recent_comment->email, 47) != null)
                        <img src="{{get_gravatar($recent_comment->email, 47)}}" alt="{{$recent_comment->name}}">
                        @else --}}
                        <img src="{{asset('assets/users/default.jpeg')}}" alt="">
                        {{-- @endif --}}
    ...
    <aside class="widget archives_widget">
        ...
        <ul>
            ...
            <li><a href="{{url('user/archive/'.($key.'-'.$val))}}">{{ date("F", mktime(0, 0, 0, $key, 1)) . ' ' . $val }}</a></li>
            @endforeach
        </ul>
    </aside>
    <!-- End Single Widget -->
